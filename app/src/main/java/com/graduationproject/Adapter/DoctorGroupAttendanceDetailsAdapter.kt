...
class DoctorGroupAttendanceDetailsAdapter( var list: List<DoctorStudentsSearchResponse>
) : RecyclerView.Adapter<DoctorGroupAttendanceDetailsAdapter.StudentsViewHolder>()
{
    ...
    class StudentsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(student : DoctorStudentsSearchResponse)
        {
